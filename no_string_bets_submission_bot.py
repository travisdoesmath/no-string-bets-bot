...
def is_serious_post(submission):
...
for submission in subreddit.stream.submissions():
    if re.search("(I see your)( *[a-zA-Z]* *){0,10}(and raise you)", submission.title) \
        and not(is_serious_post(submission)): post_reply("no string bets, please!\n\n---\n^^I'm ^^a ^^bot, ^^learn ^^more ^^about ^^string ^^bets ^^[here](https://en.wiktionary.org/wiki/string_bet)", comment)
